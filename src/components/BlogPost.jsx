  ...
  return (
    ...
    <div className="max-w-4xl mx-auto text-justify">
        ...
        <div className="space-y-5 md:space-y-5">
            ...
            {/*  */}
            <p className="text-xl font-bold text-black">1. Easy Access and Transparency</p>
            ...
            {/*  */}
            <p className="text-xl font-bold text-black">2. Micro-Ownership is Changing the Game</p>
            ...
            {/*  */}
            <p className="text-xl font-bold text-black">3. Speed and Simplicity</p>
            ...
            {/*  */}
            <p className="text-xl font-bold text-black">4. Cashback and Rewards for Buyers</p>
            ...
            {/*  */}
            <p className="text-xl font-bold text-black">5. A Smarter Future for Property Buyers</p>
