    ...
    <div className="max-w-5xl mx-auto text-justify">
        ...
        <div className="space-y-5 md:space-y-5">
            <div className="space-y-3">
                <h2 className="text-2xl font-bold md:text-3xl">Calorie-Based Meal Plans: The Smart Way to Eat Healthy in a Busy Life</h2>

                <p className="text-lg text-gray-800">Life moves fast — and for most Americans, so do our meals.</p>
                <p className='text-gray-800 text-lg'>Between work, family, and daily demands, eating healthy often feels like a challenge. Grabbing fast food or skipping meals becomes the norm, but over time, it impacts our energy, weight, and long-term health.</p>
                <p className="text-lg text-gray-800">That’s where calorie-based meal plans come in. Rather than relying on fad diets or restrictive routines, calorie-focused plans help you eat smarter — balancing convenience with nutrition.</p>
