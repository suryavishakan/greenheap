...
const Features = () => {
  return (
    <div className="flex py-16 items-center justify-center p-10 bg-orange-50">
        <div className="container grid max-w-screen-xl gap-8 lg:grid-cols-2 lg:grid-rows-2">
            <div className="row-span-2 flex flex-col rounded-md border border-slate-200">
                <div className="h-1/2 flex-1"><img src='https://www.insperity.com/wp-content/uploads/EVP_1200x630.png' className="w-full object-cover object-right-top" alt="omnichannel" /></div>
                    <div className="p-10 bg-gray-50">
                        <h3 className="text-3xl font-bold text-gray-700">Our Mission</h3>
            ...
            <div className="flex rounded-md border border-slate-200">
                <div className="flex-1 p-10 bg-gray-50">
                    <h3 className="text-3xl font-bold text-gray-700">Our Values</h3>
