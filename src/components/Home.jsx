...
const Home = () => {
  return (
    <section className="pb-12 relative overflow-hidden">
      ...
      {/* Main Content */}
      <div className="items-center pt-12 px-8 mx-auto max-w-7xl lg:px-16 md:px-12 relative z-20">
        <div className="justify-center w-full text-center lg:p-10 max-auto">
          <div className="justify-center w-full mx-auto">
            <div className="flex flex-col items-center justify-center max-w-xl gap-3 mx-auto lg:flex-row">
              <GifLooper interval={2000} width={300} />
            </div>
            <p className="mt-4 sm:px-32 text-white sm:text-xl text-sm font-semibold tracking-tighter">
              @Greenheap ❤️
            </p>
            <p className="sm:mt-8 mt-3 text-white text-4xl sm:text-6xl font-semibold tracking-tighter">
              Building <span className="underline leading-8 underline-offset-8	decoration-8 decoration-orange-400">Dreams</span>, Investing in Futures, Savoring Flavor.
            </p>
      ...
      <div className="text-center space-x-4 relative z-20">
        <a href='#foods' className="bg-orange-400 translate-y-1 text-[#fff] sm:text-lg text-xs font-bold py-2.5 px-6  rounded-full inline-flex items-center">
